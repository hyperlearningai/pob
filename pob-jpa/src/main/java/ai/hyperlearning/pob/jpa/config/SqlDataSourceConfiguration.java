package ai.hyperlearning.pob.jpa.config;
...
@EnableJpaRepositories(
		basePackages = {"ai.hyperlearning.pob.jpa.repositories"}, 
...
public class SqlDataSourceConfiguration {
	...
	public PlatformTransactionManager pobTransactionManager(
			@Qualifier("pobEntityManagerFactory") EntityManagerFactory pobEntityManagerFactory) {
